...
public abstract class SingleAccessKeyTreeDumper {
    ...
    public static File dumpSddFile(SingleAccessKeyTree tree2dump) throws IOException {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(sddFile)) {
            fileOutputStream.write(new byte[]{(byte) 0xEF, (byte) 0xBB, (byte) 0xBF});
            try (BufferedWriter sddFileWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, "UTF-8"))) {
    ...
    public static File dumpTxtFile(String header, SingleAccessKeyTree tree2dump, boolean showStatistics, final String generatedFilesFolder)
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(txtFile)) {
            fileOutputStream.write(new byte[]{(byte) 0xEF, (byte) 0xBB, (byte) 0xBF});
            try (BufferedWriter txtFileWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, "UTF-8"))) {
    ...
    public static File dumpHtmlFile(String header, SingleAccessKeyTree tree2dump, boolean showStatistics, String generatedFilesFolder)
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(htmlFile)) {
            fileOutputStream.write(new byte[]{(byte) 0xEF, (byte) 0xBB, (byte) 0xBF});
            try (BufferedWriter htmlFileWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, "UTF-8"))) {
    ...
    public static File dumpDotFile(String header, SingleAccessKeyTree tree2dump, String generatedFilesFolder) throws IOException {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(dotFile)) {
            fileOutputStream.write(new byte[]{(byte) 0xEF, (byte) 0xBB, (byte) 0xBF});
            try (BufferedWriter dotFileWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, "UTF-8"))) {
