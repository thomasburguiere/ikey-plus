...
Before running the Main class, ensure that your client is querying the SOAP version of the webservice.

In the "application-context.xml" file you can configure the server host name (line 12).
In the "IdentificationKeyRESTClient.java" file you can configure the webservice options (line 42 to line52).
